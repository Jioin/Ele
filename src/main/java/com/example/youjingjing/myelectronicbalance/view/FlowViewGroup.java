...
public class FlowViewGroup extends ViewGroup{
    ...
    public void setContent(ArrayList<TextView> content){
        for (TextView tv: content
             ) {
            this.addView(tv);
        }
    }
    public void removeContent(ArrayList<TextView> content){
...
//        }
    ...
    public void setOnItemClickListener(ArrayList<TextView> content,OnClickListener onClickListener){
        for (int i = 0; i < content.size(); i++) {
